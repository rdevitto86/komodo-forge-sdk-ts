...
export function setCtx(req: Request, key: symbol, value: unknown): void {
  ...
  if (!map) { map = new Map(); _ctx.set(req, map); }
  map.set(key, value);
}
...
export function getRequestId(req: Request):    string | undefined { return getCtx(req, CTX.REQUEST_ID) as string | undefined; }
export function getCorrelationId(req: Request): string | undefined { return getCtx(req, CTX.CORRELATION_ID) as string | undefined; }
export function getUserId(req: Request):        string | undefined { return getCtx(req, CTX.USER_ID) as string | undefined; }
export function getSessionId(req: Request):     string | undefined { return getCtx(req, CTX.SESSION_ID) as string | undefined; }
export function getScopes(req: Request):        string[] | undefined { return getCtx(req, CTX.SCOPES) as string[] | undefined; }
export function isAdmin(req: Request):          boolean { return (getCtx(req, CTX.IS_ADMIN) as boolean | undefined) ?? false; }
export function isAuthValid(req: Request):      boolean { return (getCtx(req, CTX.AUTH_VALID) as boolean | undefined) ?? false; }
export function getClientType(req: Request):    string  { return (getCtx(req, CTX.CLIENT_TYPE) as string | undefined) ?? CLIENT_TYPE_BROWSER; }
