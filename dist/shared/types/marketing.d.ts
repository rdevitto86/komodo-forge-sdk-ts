export type MarketingContentType = 'hero-banner' | 'inline-banner' | 'promo-card' | 'recommendation-grid' | 'countdown-offer' | 'social-proof' | 'cross-sell' | 'announcement-bar' | 'modal-popup' | 'exit-intent' | 'sticky-footer';
