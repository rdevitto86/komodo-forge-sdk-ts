...
function stubBrowserEnv() {
    globalThis.window = {};
    globalThis.location = { href: 'https://app.example.com/checkout' };
}
    ...
    describe('InteractionLogger', () => {
        ...
        describe('worker degradation', () => {
            ...
            it('internal onError handler calls console.warn when the browser worker degrades', () => {
                ...
                expect(vi.mocked(console.warn)).toHaveBeenCalledWith('[InteractionLogger] worker degraded, falling back to fetch:', 'worker crashed');
            });
        });
    });
});
