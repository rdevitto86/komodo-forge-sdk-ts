...
export class FargateService extends Construct {
    ...
    constructor(scope, id, props) {
        ...
        const deployColor = props.deployColor ?? 'blue';
        if (props.requireExplicitSecurityGroups && (!props.albSecurityGroup || !props.taskSecurityGroup)) {
            throw new Error('missing required albSecurityGroup or taskSecurityGroup when requireExplicitSecurityGroups is set');
        }
